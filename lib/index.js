...
function setupApp () {
  ...
  app.post('/elmis-orders', (req, res) => {
    ...
    request.post(options, (err, response, body) => {
      ...
      orchestrations.push(utils.buildOrchestration('Capturing Orchestration Data Route', new Date().getTime(), req.method, urlResponse, req.headers, req, orchestrationResponse, body))

      console.info('orchestrations', orchestrations)
